...
namespace Questionnaire.Infrastructure.Database.Migrations
{
    ...
    [Migration("20220819134026_PropertyEntityOptionsNullable")]
    partial class PropertyEntityOptionsNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Questionnaire.Domain.Entities.AnswerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Questionnaire.Domain.Entities.PropertyEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Questionnaire.Domain.Entities.QuestionnaireEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Questionnaire.Domain.Entities.AnswerEntity", b =>
                {
                    b.HasOne("Questionnaire.Domain.Entities.QuestionnaireEntity", "Questionnaire")
                        .WithMany("Answers")
